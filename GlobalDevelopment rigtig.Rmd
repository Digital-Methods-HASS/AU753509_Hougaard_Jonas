...
# du kan også bruge options(scipen = 999) for at få normale tal ved population og på x-aksen
...
- Because otherwise all the dots are in the same place close to the start of the x axis, but spread out on the y-axis
...
- We cannot answer the question with this dataset, as it has inclomplete data. It has neither data from the year I was born 2001, nor does it have data from today 2026.
